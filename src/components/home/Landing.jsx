        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              ...
              <h6 data-aos="fade-in" data-aos-delay="200" data-aos-easing="linear" data-aos-duration="1000">
                <span className="text-uppercase id-color-2">Gigaland Market</span>
              </h6>
              <div className="spacer-10"></div>
              <h1 data-aos="fade-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="700">
              ...
              <div className="spacer-10"></div>
              <div data-aos="fade-in" data-aos-easing="linear" data-aos-delay="500" data-aos-duration="1000">
